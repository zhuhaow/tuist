...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            name: "TuistCoreTests",
            dependencies: ["TuistCore", "TuistCoreTesting", "TuistSupportTesting", "TuistGalaxyTesting"]
        ),
        .testTarget(
        ...
        .target(
            name: "TuistKit",
            dependencies: ["XcodeProj", "SPMUtility", "TuistSupport", "TuistGenerator", "TuistGalaxy", "TuistAutomation", "ProjectDescription", "Signals", "RxSwift", "RxBlocking", "Checksum", "TuistLoader"]
        ),
        .testTarget(
            name: "TuistKitTests",
